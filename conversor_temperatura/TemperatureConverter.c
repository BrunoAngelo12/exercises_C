...
void convertCelsiusToFahrenheit(){
    ...
    printf("The value in Celsius that was inputted converted to Fahrenheit is %f", fltFahrenheit);
}
...
void convertFahrenheitToCelsius(){
    ...
    printf("The value in Fahrenheit that was inputted converted to Celsius is %f", fltCelsius);
}
